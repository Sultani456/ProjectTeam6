...
public class EnemyFactory {
    ...
    // This class makes enemy objects for the game.
    ...
    public static List<Enemy> fromGridAndClear(char[][] grid) {
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                // If we see a 'B', that means there should be a chaser enemy here.
                if (grid[r][c] == 'B') {
                    // Make a new enemy at this column and row.
    ...
    public static List<Enemy> forLevel(int level, List<int[]> spawns) {
        ...
        // Later we can use the level value to pick different enemy types.
        return list;
    }
}
